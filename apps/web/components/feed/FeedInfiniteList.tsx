  ...
  return (
    <div className="relative px-3 py-2 lg:px-4 lg:py-3">
      <div className="flex items-center gap-3 lg:gap-4">
        ...
        >
          <div className="flex items-baseline gap-1 text-label text-text-tertiary leading-tight lg:text-[12.5px]">
          ...
          <div className="mt-0.5 flex items-baseline gap-1 text-meta leading-snug lg:text-[15px]">
      ...
      {expanded && (
        <div className="mt-2 ml-11 border-l border-rule pl-3 space-y-1.5 lg:mt-3 lg:ml-12 lg:space-y-2">
          {group.items.map((item) => (
            <Link
              key={item.id}
              href={item.href}
              className="flex items-center gap-2 py-1 rounded-sm hover:text-accent-deep transition-colors duration-150 lg:gap-3"
            >
